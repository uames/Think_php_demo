...
class ChromeShowPageTraceBehavior {
    ...
    private function showTrace() {
        ...
        $base   =   array(
            ...
            '运行时间'  =>  $this->showTime(),
			'吞吐率'	=>	number_format(1/Gr('beginTime','viewEndTime'),2).'req/s',
    ...
    private function showTime() {
        // 显示运行时间
        Gr('beginTime',$GLOBALS['_beginTime']);
        Gr('viewEndTime');
        // 显示详细运行时间
        return Gr('beginTime','viewEndTime').'s ( Load:'.Gr('beginTime','loadTime').'s Init:'.Gr('loadTime','initTime').'s Exec:'.Gr('initTime','viewStartTime').'s Template:'.Gr('viewStartTime','viewEndTime').'s )';
    }
}
