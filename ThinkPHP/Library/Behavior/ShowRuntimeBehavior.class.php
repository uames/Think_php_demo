...
class ShowRuntimeBehavior {
    ...
    private function showTime() {
        ...
        Gr('viewEndTime');
        $showTime   =   'Process: '.Gr('beginTime','viewEndTime').'s ';
        if(C('SHOW_ADV_TIME')) {
            // 显示详细运行时间
            $showTime .= '( Load:'.Gr('beginTime','loadTime').'s Init:'.Gr('loadTime','initTime').'s Exec:'.Gr('initTime','viewStartTime').'s Template:'.Gr('viewStartTime','viewEndTime').'s )';
        }
