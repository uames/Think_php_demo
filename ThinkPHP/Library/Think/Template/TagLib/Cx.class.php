...
class Cx extends TagLib {
    ...
    protected $tags   =  array(
        ...
        'patch'     =>  array('attr'=>'name'),
        'renderPatch' => array('attr'=>'patch', 'close'=>0)
        );
	
    private static $patchs = array();
    ...
    public function _patch($tag, $content) {
    	Cx::$patchs[$tag['name']] = $content;
    	return '';
    }
    ...
    public function _renderPatch($tag) {
    	return Cx::$patchs[$tag['patch']];
    }
